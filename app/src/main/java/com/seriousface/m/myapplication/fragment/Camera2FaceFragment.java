...
import com.seriousface.m.myapplication.activity.FlashActivity;
import com.seriousface.m.myapplication.adapter.EffectAdapter;
import com.seriousface.m.myapplication.adapter.FlashAdapter;
import com.seriousface.m.myapplication.adapter.SenseAdapter;
import com.seriousface.m.myapplication.callback.DngSessionCallback;
import com.seriousface.m.myapplication.callback.JpegSessionCallback;
import com.seriousface.m.myapplication.callback.PreviewSessionCallback;
import com.seriousface.m.myapplication.listener.AwbSeekBarChangeListener;
import com.seriousface.m.myapplication.listener.EffectItemClickListener;
import com.seriousface.m.myapplication.listener.FlashItemClickListener;
...
import com.seriousface.m.myapplication.view.MyTextureView;
 ...
 */
@TargetApi(21)
public class Camera2FaceFragment extends Fragment implements View.OnClickListener {

    private static Camera2FaceFragment camera2FaceFragment;

    public static Camera2FaceFragment newInstance() {
        if (camera2FaceFragment == null) {
            camera2FaceFragment = new Camera2FaceFragment();
        }
        return camera2FaceFragment;
    }
...
//            mToPreviewHeight =
    ...
    private CameraDevice.StateCallback mCameraDeviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            Log.i("StateCallback", "onDisconnected");
            Toast.makeText(getActivity(), "onDisconnected", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError(CameraDevice cameraDevice, int i) {
            Log.i("StateCallback", "onError--->" + i + ",,,null == cameraDevice--->" + (null == cameraDevice));
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            Log.i("CameraCaptureSession", "mSessionStateCallback--->onConfigured");
            try {
        ...
        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
            Log.i("CameraCaptureSession", "mSessionStateCallback--->onConfigureFailed");
        ...
        public void onReady(CameraCaptureSession session) {
            ...
            Log.i("CameraCaptureSession", "mSessionStateCallback--->onReady");
        }

        @Override
        public void onActive(CameraCaptureSession session) {
            super.onActive(session);
            Log.i("CameraCaptureSession", "mSessionStateCallback--->onActive");
        }

        @Override
        public void onClosed(CameraCaptureSession session) {
            super.onClosed(session);
            Log.i("CameraCaptureSession", "mSessionStateCallback--->onClosed");
        }
    };
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_setting:
                ...
                getActivity().getFragmentManager().beginTransaction().replace(R.id.fl_contain, settingFragment).addToBackStack(null).commit();
                break;
            ...
            case R.id.btn_zoom_2:
                ...
                break;
            case R.id.btn_album:
                getActivity().getFragmentManager().beginTransaction().replace(R.id.fl_contain, AlbumFragment.newInstance()).addToBackStack(null).commit();
                break;
            case R.id.btn_sense:
