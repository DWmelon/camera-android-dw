package com.seriousface.m.myapplication.wxapi;
...
import com.seriousface.m.myapplication.util.BitmapUtil;
...
public class WXShareManager{
	...
	private void sharePicture(int shareType, ShareContent shareContent) {
		...
		Bitmap thumbBmp = Bitmap.createScaledBitmap(bmp2, THUMB_SIZE, THUMB_SIZE, true);
		bmp2.recycle();
