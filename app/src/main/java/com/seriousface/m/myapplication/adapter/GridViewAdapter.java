...
public class GridViewAdapter extends BaseAdapter {
    ...
    Context context;
    int[] resIds = {R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test,R.drawable.icon_test};
