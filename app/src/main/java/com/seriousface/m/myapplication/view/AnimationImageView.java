package com.seriousface.m.myapplication.view;
...
import com.seriousface.m.myapplication.SleepThread;
...
public class AnimationImageView extends ImageView {
    ...
    public void initFocus() {
        ...
        new Thread(new SleepThread(mMainHandler, Camera2FaceFragment.FOCUS_DISAPPEAR, 1000, null)).start();
    }
    ...
    public void startFocusing() {
        ...
        new Thread(new SleepThread(mMainHandler, Camera2FaceFragment.FOCUS_DISAPPEAR, 1000, Integer.valueOf(mTimes))).start();
    }

    public void focusFailed() {
        mTimes++;
        this.setBackground(mContext.getDrawable(R.drawable.focus_failed));
        new Thread(new SleepThread(mMainHandler, Camera2FaceFragment.FOCUS_DISAPPEAR, 800, Integer.valueOf(mTimes))).start();
    }
